...
#PBS -N parallel_searchlight_pbs \n\
...
exit 0")
    ...
    def reassemble_():
        ...
        print("Cleaning up...")
        os.system("rm parallel_searchlight_pbs*") # delete all the automatically generated error and output files in the home directory
