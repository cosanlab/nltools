...
def get_collection_image_metadata(collection=collection, data_dir = None,
                                  limit=10):
	...
	Returns:
		metadata:	(pd.DataFrame) Dataframe with full image metadata from collection
...
def download_collection(collection=collection, data_dir=data_dir, overwrite=False, 
