...
- `plot_surf` and `plot_flatmap` interpolate volume data onto an fsaverage mesh with a fixed
  3 mm sampling ball. They are visualizations of volume data, not surface analyses.
