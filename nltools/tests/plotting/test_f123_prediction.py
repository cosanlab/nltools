...
class TestPlotRoc:
    def test_returns_figure(self):
        """F125: _plot_roc returns the matplotlib Figure (was bare return -> None)."""
        fpr = [0.0, 0.1, 0.4, 1.0]
        tpr = [0.0, 0.6, 0.9, 1.0]
...
class TestPlotPredictedVersusActual:
    def test_names_the_correlation_in_the_title(self):
        ...
        axis = _plot_predicted_versus_actual(y_true, y_pred, r=0.98)
...
class TestPlotDecisionMargin:
    def test_groups_the_margins_by_class(self):
        ...
        axis = _plot_decision_margin(margins, y_true)
...
class TestPlotClassProbability:
    def test_groups_the_probabilities_by_class(self):
        ...
        axis = _plot_class_probability(probabilities, y_true)
