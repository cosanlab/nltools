...
class TestBrainCollectionFit:
    ...
    def test_fit_glm_dispatches_correctly(self, small_collection, shared_design_matrix):
        ...
        assert result.results[0].shape[0] == 3  # face, house, constant
    ...
    def test_fit_ridge_dispatches_correctly(self, small_collection, shared_features):
        ...
        assert result.results[0].shape[0] == 1
    ...
    def test_fit_glm_with_return_stats(self, small_collection, shared_design_matrix):
        ...
        assert "betas" in result.results
    ...
    def test_fit_glm_with_numpy_array(self, small_collection):
        ...
        assert isinstance(result.results, BrainCollection)
        assert len(result.results) == 3
        assert result.results[0].shape[0] == 4
    ...
    def test_fit_ridge_with_output_weights(self, small_collection, shared_features):
        ...
        assert result.results[0].shape[0] == 5
    ...
    def test_fit_ridge_with_output_both(self, small_collection, shared_features):
        ...
        assert isinstance(result, FittedBrainCollection)
        assert isinstance(result.results, dict)
        assert "scores" in result.results
        assert "weights" in result.results
        assert len(result.results["scores"]) == 3
        assert len(result.results["weights"]) == 3
