...
class TestReductionsROI:
    ...
    def test_align_roi_not_implemented(self, minimal_brain_data):
        atlas = _atlas_for(minimal_brain_data, n_rois=2)
        with pytest.raises(NotImplementedError, match="spatial_scale"):
            minimal_brain_data.align(
                minimal_brain_data, spatial_scale="roi", roi_mask=atlas
            )
