...
Every public function and class of `nltools.algorithms`, alphabetically, with the page that documents it. The *Functions by task* pages group the same objects by what they are for.
...
[`compute_multivariate_similarity`][nltools.algorithms.compute_multivariate_similarity] | [Similarity & RSA](tasks/similarity.md)
[`compute_searchlight_neighborhoods`][nltools.data.braindata.neighborhoods.compute_searchlight_neighborhoods] | [Searchlight neighborhoods](neighborhoods.md)
...
[`DetSRM`][nltools.algorithms.DetSRM] | [Functional alignment](tasks/alignment.md)
[`distance_correlation`][nltools.algorithms.distance_correlation] | [Similarity & RSA](tasks/similarity.md)
[`double_center`][nltools.algorithms.double_center] | [Similarity & RSA](tasks/similarity.md)
...
[`glover_dispersion_derivative`][nltools.algorithms.glover_dispersion_derivative] | [Design matrices, HRF & GLM](tasks/design-and-glm.md)
[`glover_hrf`][nltools.algorithms.glover_hrf] | [Design matrices, HRF & GLM](tasks/design-and-glm.md)
[`glover_time_derivative`][nltools.algorithms.glover_time_derivative] | [Design matrices, HRF & GLM](tasks/design-and-glm.md)
[`holm_bonf`][nltools.algorithms.holm_bonf] | [Statistics & inference](tasks/inference.md)
[`HyperAlignment`][nltools.algorithms.HyperAlignment] | [Functional alignment](tasks/alignment.md)
...
[`isc_group_permutation_test`][nltools.algorithms.isc_group_permutation_test] | [Intersubject correlation](tasks/intersubject.md)
[`isc_permutation_test`][nltools.algorithms.isc_permutation_test] | [Intersubject correlation](tasks/intersubject.md)
...
[`LocalAlignment`][nltools.algorithms.LocalAlignment] | [Functional alignment](tasks/alignment.md)
...
[`SphereNeighborhoods`][nltools.data.braindata.neighborhoods.SphereNeighborhoods] | [Searchlight neighborhoods](neighborhoods.md)
[`spm_dispersion_derivative`][nltools.algorithms.spm_dispersion_derivative] | [Design matrices, HRF & GLM](tasks/design-and-glm.md)
[`spm_hrf`][nltools.algorithms.spm_hrf] | [Design matrices, HRF & GLM](tasks/design-and-glm.md)
[`spm_time_derivative`][nltools.algorithms.spm_time_derivative] | [Design matrices, HRF & GLM](tasks/design-and-glm.md)
[`SRM`][nltools.algorithms.SRM] | [Functional alignment](tasks/alignment.md)
[`threshold`][nltools.algorithms.threshold] | [Statistics & inference](tasks/inference.md)
[`timeseries_correlation_permutation_test`][nltools.algorithms.timeseries_correlation_permutation_test] | [Statistics & inference](tasks/inference.md)
...
[`u_center`][nltools.algorithms.u_center] | [Similarity & RSA](tasks/similarity.md)
